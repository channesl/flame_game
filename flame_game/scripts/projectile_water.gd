...
@onready var shoot_audio = preload("res://scenes/audio/audio_stream_player_water_shoot.tscn")
@onready var hit_audio = preload("res://scenes/audio/audio_stream_player_water_hit.tscn")
